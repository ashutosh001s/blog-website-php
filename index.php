...
<head>
    ...
    <meta name="description"
        content="Blogg Bat is a free to used web page provides information about 4d era like genetics , AI , robotics etc.">
    ...
    <link type="text/css" rel="stylesheet" href="./assets/css/bootstrap.scss">
    ...
    <Section id="FirstSection">
        <div class="container newsletterForm">
            ...
            <div class="container formBox">
                ...
                <p class="formTextSmall">Signup and receive our exclusive blogging and digital marketing tips right in
                    your inbox.</p>
