      ...
      <div class="sidebar ">
        ...
        <div class="postSearchbar">
          <form action="../search" method="GET">
            <input type="text" class="form-control search-bar" name="query" aria-describedby="Search" placeholder="Search" style="border: none;" required>
          </form>
        </div>
        <!-- search bar start  -->
        ...
        <div class="postNewsletter">
          ...
          <form class="emailForm" action="/action.php" method="POST">
            <div class="mb-3">
              <input type="text" class="form-control newsletterInput" id="name" name="fname" placeholder="Enter your first name" required>
            </div>
            <div class="mb-3">
              <input type="email" class="form-control newsletterInput" id="email" name="email" placeholder="Enter your email" required>
            </div>
